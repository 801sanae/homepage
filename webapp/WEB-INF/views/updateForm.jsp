...
<c:import url="/WEB-INF/views/import/nav.jsp"/>
	...
	<div class="col-md-6">
		<form method="post" action="${pageContext.request.contextPath}/board/update?no=${board.no}">
			<table>
					<tr>
						<td>제목</td>
				...
				<a href="${pageContext.request.contextPath}/board/view?no=${board.no}"><b>뒤로가기</b></a>
				<input id="btn" type="submit" value="등록" class="btn-primary">
		</form>
